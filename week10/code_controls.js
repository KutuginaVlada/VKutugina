...
function init()
{
	...
	const boxmaterials = [
		new THREE.MeshBasicMaterial( { map: loader.load( 'instagram.jpg') } ),
		new THREE.MeshBasicMaterial( { map: loader.load( 'yotube.jpg') } ),
		new THREE.MeshBasicMaterial( { map: loader.load( 'twiter.jpg') } ),
		new THREE.MeshBasicMaterial( { map: loader.load( 'google.jpg') } ),
		new THREE.MeshBasicMaterial( { map: loader.load( 'pinterest.jpg') } ),
		new THREE.MeshBasicMaterial( { map: loader.load( 'in.jpg') } ),
	];
